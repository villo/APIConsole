		...
		console: {
			...
			actions: {
				...
				"help": {
					run: function(){
						villo.console.write(
							...
							"   - doc villo.ajax  -  Retrieves the documentation for any given villo function. Simply replace \"villo.ajax\" with any villo function. \n"+
				...
				"doc": {
					run: function(){
						if(true){
							var divid = "spanx" + Math.round(Math.random() * 9999999);
							villo.console.jqconsole.Write("<iframe src='villojs/docs/index.html#villo.chat.join_d' style='width: 600px; height: 450px;'></iframe>" + "\n", 'jqconsole-output', false);
							$("#" + divid).load("villojs/docs/index.html#villo.chat.join");
						}else{
							villo.console.write("Error loading the documentation for that file.");
						}
						return true;
					}
				},
