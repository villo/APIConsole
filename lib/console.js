				...
				"doc": {
					run: function(){
						if(true){
							...
							villo.console.jqconsole.Write("<div id='" + divid + "' style='width: 400px; height: 450px;'></iframe>" + "\n", 'jqconsole-output', false);
							$("#" + divid).load("http://villo.github.com/villojs/docs/index.html#villo.chat.join");
						}else{
